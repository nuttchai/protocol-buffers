...
const uint32_t TableStruct_city_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::City, country_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_city_2eproto = {
  false, false, 77, descriptor_table_protodef_city_2eproto, "city.proto", 
  &descriptor_table_city_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_city_2eproto::offsets,
  file_level_metadata_city_2eproto, file_level_enum_descriptors_city_2eproto, file_level_service_descriptors_city_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_city_2eproto_getter() {
  return &descriptor_table_city_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_city_2eproto(&descriptor_table_city_2eproto);
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "City.country"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;

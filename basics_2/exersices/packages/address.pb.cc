...
const char descriptor_table_protodef_address_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\raddress.proto\032\023building_pack.proto\032\021st"
  "reet_pack.proto\032\017city_pack.proto\"i\n\007Addr"
  "ess\022\030\n\004city\030\001 \001(\0132\n.city.City\022\036\n\006street\030"
  "\002 \001(\0132\016.street.Street\022$\n\010building\030\003 \001(\0132"
  "\022.building.Buildingb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_address_2eproto_deps[3] = {
  &::descriptor_table_building_5fpack_2eproto,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_address_2eproto = {
  false, false, 187, descriptor_table_protodef_address_2eproto, "address.proto", 
...
Address::Address(const Address& from)
  ...
  if (from._internal_has_building()) {
    building_ = new ::building::Building(*from.building_);
  } else {
    building_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Address)
  ...
  if (from._internal_has_building()) {
    _internal_mutable_building()->::building::Building::MergeFrom(from._internal_building());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

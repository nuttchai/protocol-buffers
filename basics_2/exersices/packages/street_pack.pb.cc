...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_street_5fpack_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_street_5fpack_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_street_5fpack_2eproto = nullptr;

const uint32_t TableStruct_street_5fpack_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_street_5fpack_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021street_pack.proto\022\006street\032\017city_pack.p"
  "roto\"0\n\006Street\022\014\n\004name\030\001 \001(\t\022\030\n\004city\030\002 \001"
  "(\0132\n.city.Cityb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_street_5fpack_2eproto_deps[1] = {
  &::descriptor_table_city_5fpack_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_street_5fpack_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_street_5fpack_2eproto = {
  false, false, 102, descriptor_table_protodef_street_5fpack_2eproto, "street_pack.proto", 
  &descriptor_table_street_5fpack_2eproto_once, descriptor_table_street_5fpack_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_street_5fpack_2eproto::offsets,
  file_level_metadata_street_5fpack_2eproto, file_level_enum_descriptors_street_5fpack_2eproto, file_level_service_descriptors_street_5fpack_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_street_5fpack_2eproto_getter() {
  return &descriptor_table_street_5fpack_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_street_5fpack_2eproto(&descriptor_table_street_5fpack_2eproto);
namespace street {
...
::PROTOBUF_NAMESPACE_ID::Metadata Street::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_street_5fpack_2eproto_getter, &descriptor_table_street_5fpack_2eproto_once,
      file_level_metadata_street_5fpack_2eproto[0]);
}
